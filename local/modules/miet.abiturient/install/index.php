...
Битрикс CModule*/
Class miet_abiturient extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.abiturient";
    var $MODULE_ID = "miet.abiturient";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.abiturient_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("miet.abiturient_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.abiturient_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.abiturient_PARTNER_URI");
    }
